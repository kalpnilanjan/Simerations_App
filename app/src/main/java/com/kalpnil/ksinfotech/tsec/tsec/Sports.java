...
public class Sports extends AppCompatActivity {
    ...
    public SportsViewAdapter adapter;
    int icons[] = {R.drawable.stumped,R.drawable.f2,R.drawable.uvtt,R.drawable.sfs,R.drawable.bucket2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SportsViewAdapter(getData(icons, getResources().getStringArray(R.array.sports_array)));
