        ...
        public void onClick(View v) {
            switch(getAdapterPosition()){
                ...
                case 1: context.startActivity(new Intent(context,Notices.class));
                    break;
                case 2:
                    context.startActivity(new Intent(context,Cultural.class));
                    break;
                case 3:
                    context.startActivity(new Intent(context,General.class));
                    break;
                case 4:context.startActivity(new Intent(context,Management.class));
                    break;
                case 5: context.startActivity(new Intent(context,Literary.class));
                    break;
                case 6: context.startActivity(new Intent(context,Sports.class));
                    break;
                case 7:
