...
public class General extends AppCompatActivity {
    ...
    public GeneralViewAdapter adapter;
    int icons[] = {R.drawable.gf,R.drawable.picturesque,R.drawable.cc,R.drawable.jive,R.drawable.paintball,R.drawable.lan1};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GeneralViewAdapter(getData(icons, getResources().getStringArray(R.array.general_array)));
