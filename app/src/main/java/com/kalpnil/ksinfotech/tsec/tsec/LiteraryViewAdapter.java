 ...
 */
public class LiteraryViewAdapter extends RecyclerView.Adapter<LiteraryViewAdapter.MyViewHolder> {
    int[] img = {0, 1};
    List<Information> data = Collections.emptyList();
    private LayoutInflater inflater;

    public LiteraryViewAdapter(List<Information> data) {
        this.data = data;
    }
            ...
            switch (getAdapterPosition()) {
                ...
                case 0:
                    try {
                        ...
                        c = Class.forName("com.kalpnil.ksinfotech.tsec.tsec.LiteraryDetail");
