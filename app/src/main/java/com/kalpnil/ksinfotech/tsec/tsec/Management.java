...
public class Management extends AppCompatActivity {
    ...
    int icons[] = {R.drawable.bnb,R.drawable.whp,R.drawable.conv,R.drawable.fin,R.drawable.lms,R.drawable.whiz,R.drawable.cdb,R.drawable.ams};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ManagementAdapter(getData(icons, getResources().getStringArray(R.array.management_array)));
