 ...
 */
public class GeneralViewAdapter extends RecyclerView.Adapter<GeneralViewAdapter.MyViewHolder> {
    int[] img = {0, 1, 2, 3, 4, 5};
    List<Information> data = Collections.emptyList();
    private LayoutInflater inflater;

    public GeneralViewAdapter(List<Information> data) {
        this.data = data;
    }
            ...
            switch (getAdapterPosition()) {
                ...
                case 0:
                    try {
                        ...
                        c = Class.forName("com.kalpnil.ksinfotech.tsec.tsec.GeneralDetail");
