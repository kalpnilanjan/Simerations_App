 ...
 */
public class SportsViewAdapter extends RecyclerView.Adapter<SportsViewAdapter.MyViewHolder> {
    int[] img = {0, 1, 2, 3, 4};
    List<Information> data = Collections.emptyList();
    private LayoutInflater inflater;

    public SportsViewAdapter(List<Information> data) {
        this.data = data;
    }
            ...
            switch (getAdapterPosition()) {
                ...
                case 0:
                    try {
                        ...
                        c = Class.forName("com.kalpnil.ksinfotech.tsec.tsec.SportsDetail");
