 ...
 */
public class CulturalViewAdapter extends RecyclerView.Adapter<CulturalViewAdapter.MyViewHolder> {
    int[] img = {0, 1, 2, 3};
    List<Information> data = Collections.emptyList();
    private LayoutInflater inflater;

    public CulturalViewAdapter(List<Information> data) {
        this.data = data;
    }
            ...
            switch (getAdapterPosition()) {
                ...
                case 0:
                    try {
                        ...
                        c = Class.forName("com.kalpnil.ksinfotech.tsec.tsec.CulturalDetail");
