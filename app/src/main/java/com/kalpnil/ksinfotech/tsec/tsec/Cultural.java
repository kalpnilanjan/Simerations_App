...
public class Cultural extends AppCompatActivity {
    ...
    public CulturalViewAdapter adapter;
    int icons[] = {R.drawable.bbt,R.drawable.lwd,R.drawable.sd,R.drawable.wod};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CulturalViewAdapter(getData(icons, getResources().getStringArray(R.array.cultural_array)));
